...
- A lo largo de una línea coordenada \(x^i\) se muestra que el parámetro natural es la longitud de arco \(s_i\),
  ...
  Es decir, los vectores base unitarios están parametrizados por la longitud natural de sus líneas coordenadas.

## Archivos

- `bases_fig1.png`, `bases_fig2.png` — Esquemas de las líneas coordenadas y los vectores base.
- `met_fig1.png` — Dibujo del elemento de línea y la métrica en el punto.
